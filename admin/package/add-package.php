				...
				<form role="form" method="post" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group col-md-5">
								<label for="Description">Detailed Itinerary</label>
								<textarea name="desc1" id="desc1" class="ckeditor"  placeholder="Enter Detailed Itinerary Description..." style="height: 100px;" required></textarea>
						</div>
					...
					<div class="box-body">
						...
						<div class="form-group col-md-3">
								...
								<textarea name="desc10" id="desc10" class="ckeditor" placeholder="Enter Description..." style="height: 100px;" required></textarea>
						</div>
					</div>
