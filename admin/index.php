			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="<?php echo $clasess ?>">
							<a href="index.php?page=clasess/list-clasess">
								<i class="fa fa-book"></i>&nbsp; <span>clasess</span>
							</a>
						</li>
						<li class="<?php echo $about ?>">
							<a href="index.php?page=about/list-about">
						...
						<li class="<?php echo $whyus ?>">
							<a href="index.php?page=whyus/index">
								<i class="fa fa-comments-o"></i>&nbsp; <span>whyus</span>
							</a>
						</li>
						...
						<li class="<?php echo $applynow ?>">
							<a href="index.php?page=applynow/list-applynow">
						...
						<li class="treeview <?php echo $tab_packages ?>">
							...
							<ul class="treeview-menu">
								...
								<li class="<?php echo $package_desc ?>">
									<a href="http://localhost/quest/form.php">
										<i class="fa fa-circle-o"></i>Add popup desc
									</a>
								</li>
							</ul>
						</li>
